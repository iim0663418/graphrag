...
3. Return output in the same language as the input text, with entity and relationship names in their original language. Use **{record_delimiter}** as the list delimiter.
